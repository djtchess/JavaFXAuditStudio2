...
- Traite `AGENTS.md` et `/.codex` comme references non modifiables sans demande explicite.
- Stabilise modules, perimetre, roadmap et arbitrages avant toute implementation.

Mission:
- Cadrer la solution cible a partir du guide et du depot reel.
- Produire l'architecture cible, les limites de perimetre et la trajectoire de migration.
