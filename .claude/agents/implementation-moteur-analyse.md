...
- Code seulement a partir d'une architecture et de contrats stabilises.
- Garde separes ingestion, analyse, consolidation, planification de refactoring et restitution.

Mission:
- Coder les modules du moteur d'analyse et de generation.
- Transformer les specifications du moteur en composants executables et testables.
