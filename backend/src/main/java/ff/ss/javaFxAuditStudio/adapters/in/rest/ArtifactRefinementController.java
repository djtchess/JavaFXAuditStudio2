...
public class ArtifactRefinementController {
    ...
    @Operation(summary = "Raffiner un artefact genere",
    ...
    public ResponseEntity<AiCodeGenerationResponse> refine(
        ...
        LOG.debug("Raffinement IA demande - session={}, artifactType={}", sessionId, request.artifactType());
        ...
        try {
            AiCodeGenerationResult result = refineArtifactUseCase.refine(
                    sessionId,
