...
class ProduceRestitutionServiceTest {
    ...
    void handle_shouldGenerateMarkdownAndReturnEnrichedReport_whenNoCacheIsPresent() {
        ...
        RestitutionSummary summary = new RestitutionSummary(
                ...
                ConfidenceLevel.LOW,
                false);
        RestitutionReport savedReport = new RestitutionReport(summary, List.of(), List.of(), List.of());
        ...
        when(restitutionFormatterPort.formatAsMarkdown(savedReport)).thenReturn("# Restitution\n\n## Synthese");
        ...
        verify(restitutionFormatterPort).formatAsMarkdown(savedReport);

        assertThat(reportCaptor.getValue().markdown()).isBlank();
    ...
    @Test
    void handle_shouldEnrichCachedReportWithoutSavingAgain() {
        RestitutionSummary summary = new RestitutionSummary(
                "CachedController",
                2,
                1,
